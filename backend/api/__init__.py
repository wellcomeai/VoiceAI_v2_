...
from .knowledge_base import router as knowledge_base_router  # Добавляем импорт
...
api_router.include_router(knowledge_base_router, prefix="/knowledge-base", tags=["Knowledge Base"])  # Добавляем маршрут
...
__all__ = [
    ...
    "admin_router",
    "knowledge_base_router"  # Добавляем в экспорт
]
